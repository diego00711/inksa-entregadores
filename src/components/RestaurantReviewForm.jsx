// Entregador avalia o restaurante/parceiro. Padrão único do app: só estrelas +
// comentário opcional — sem tags, sem notas por categoria.
...
export default function RestaurantReviewForm({ restaurantId, orderId, restaurantName, onSuccess }) {
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-green-700 text-xs">Obrigado pelo feedback sobre o parceiro.</p>
          </div>
        </div>
      </div>
    );
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
        <label className="block text-sm font-semibold text-gray-800 mb-3">
          Como foi a retirada em {restaurantName || 'no parceiro'}?
        </label>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Tempo de espera, organização, atendimento..."
          rows={3}
          maxLength={200}
